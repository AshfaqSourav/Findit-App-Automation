...
//            MobileElement otpField = waitUntilElementIsVisible(LocatorType.UI_AUTOMATOR,locator);
//            otpField.click();
//
...
//        this.sleep(2000);
////        this.clickButton("FALLBACK_BUTTON" ,LocatorClassName.LOGIN_LOCATOR_CLASS.toString() , LocatorType.UI_AUTOMATOR);
////        logger.info("Clicked on FALLBACK_BUTTON");
...
//        this.clickButton("LOGIN_EMAIL_NEXT_BUTTON",LocatorClassName.LOGIN_LOCATOR_CLASS.toString(),LocatorType.UI_AUTOMATOR);
...
//        this.sleep(3000);
////        logger.info("Completed LoginWithEmail process and waited for 5 seconds.");
//
//    }
//}
//
