...
public class ProductUploadLocatorsIOS {
    ...
    public static final String CATEGORY_FIELD_EMPTY = "//android.view.View[@content-desc=\"Pilih kategori\"]";
    ...
    public static final String NEXT_BUTTON = "new UiSelector().className(\"android.widget.Button\").index(2)";
